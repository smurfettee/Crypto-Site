export default function ChooseUs(){
    ...
    return (
        <div className=" w-3/4  flex flex-col items-center mb-60">
            <div className="m-10 font-semibold  text-5xl text-indigo-800">Why Coinsafe?</div>
            <div className="flex">
                ...
                <div className="m-10 flex flex-col items-center w-1/3">
                    ...
                    <div className="text-xl text-[#242424]">Not sure where to start? Head to our Discord and learn about all things crypto.</div>
                </div>
                <div className="m-10 flex flex-col items-center w-1/3">
