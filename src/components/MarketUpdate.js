...
export default function MarketUpdate(){
    ...
    return (
        <div id="marketUpdate" className="flex flex-col items-center mb-36 md:w-full">
            ...
            <div className="md:overflow-auto self-start flex flex-col items-center md:w-full">
                <div className="flex justify-between text-2xl bg-indigo-800 text-white rounded-t-xl p-2 font-medium md:self-start">
